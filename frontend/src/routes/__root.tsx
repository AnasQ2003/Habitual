...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A beautiful, animated habit tracker mobile app concept." },
      { name: "author", content: "Pulse" },
      { property: "og:title", content: "Pulse — Habit Tracker" },
      { property: "og:description", content: "A beautiful, animated habit tracker mobile app concept." },
